...
def main():
    ...
    if args.status == 'start':
        server.send_start(args.email, link='http://clark.compbio.iupui.edu/regsnp_intron_web/submission.php?query_id={0}'.format(args.query_id))
    elif args.status == 'end':
        server.send_end(args.email, link='http://clark.compbio.iupui.edu/regsnp_intron_web/result.php?query_id={0}'.format(args.query_id))
